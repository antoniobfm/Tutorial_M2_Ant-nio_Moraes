...
formacoesRoutes.post('/insereFormacao', (req, res) => {
  ...
  const sql = `INSERT INTO formacoes (usuario_id, nome, inicio, fim, descricao) VALUES ('${usuario_id}', '${nome}', ${inicio}, ${fim || null}, '${descricao}')`;
  ...
  db.run(sql, [], function (err) {
    ...
    res.send(`Formação com ID ${this.lastID} inserida com sucesso`);
  });
});
